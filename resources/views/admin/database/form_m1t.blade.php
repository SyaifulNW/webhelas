...
<head>
    ...
    <title>FORM DATA PESERTA OPEN HOUSE M1T</title>
...
<div class="container form-container">
    ...
    <form action="{{ route('form.m1t.store') }}" method="POST">
        ...
        <div class="form-header">
            <h1>
                FORM DATA PESERTA OPEN HOUSE M1T
        ...
        <div class="card-question">
            ...
            <div class="form-check">
                <input class="form-check-input score-radio" type="radio" name="omset" id="omset1" value="1" data-label="< 10 juta" required>
                <label class="form-check-label" for="omset1">&lt; 10 juta</label>
            </div>
            <div class="form-check">
                <input class="form-check-input score-radio" type="radio" name="omset" id="omset2" value="3" data-label="10 – 50 juta" required>
                <label class="form-check-label" for="omset2">10 – 50 juta</label>
            </div>
            <div class="form-check">
                <input class="form-check-input score-radio" type="radio" name="omset" id="omset3" value="4" data-label="50 – 100 juta" required>
                <label class="form-check-label" for="omset3">50 – 100 juta</label>
            </div>
            <div class="form-check">
                <input class="form-check-input score-radio" type="radio" name="omset" id="omset4" value="5" data-label="> 100 juta" required>
                <label class="form-check-label" for="omset4">&gt; 100 juta</label>
            </div>
        </div>
        ...
        <div class="card-question">
            <div class="question-title">7. Tantangan utama dalam bisnis Anda saat ini: <span class="text-danger">*</span></div>
        ...
        <div class="card-question">
            <div class="question-title">8. Target utama Anda dalam 1 tahun ke depan: <span class="text-danger">*</span></div>
        ...
        <div class="card-question">
            <div class="question-title">9. Seberapa kuat alasan Anda untuk mencapai target tersebut: <span class="text-danger">*</span></div>
        ...
        <div class="card-question">
            <div class="question-title">10. Jika ada program pendampingan bisnis yang tepat, posisi Anda saat ini: <span class="text-danger">*</span></div>
        ...
        <div class="card-question">
            <div class="question-title">11. Untuk pengembangan bisnis, kisaran investasi yang realistis bagi Anda: <span class="text-danger">*</span></div>
        ...
        <div class="card-question">
            <div class="question-title">12. Kesiapan anda untuk mengikuti seminar bisnis / open house sampai selesai: <span class="text-danger">*</span></div>
        ...
        <div class="card-question">
            <div class="question-title">13. Jika merasa program ini cocok, apakah Anda siap mengambil keputusan: <span class="text-danger">*</span></div>
        ...
        <div class="card-question">
            <div class="question-title">14. Berapa Jumlah Karyawan di Bisnis Anda <span class="text-danger">*</span></div>
        ...
        <div class="card-question text-center bg-light">
